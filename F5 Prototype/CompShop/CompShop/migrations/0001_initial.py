# Generated by Django 4.1.6 on 2023-03-02 17:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='customerid',
            field=models.ForeignKey(db_column='customerid', on_delete=django.db.models.deletion.DO_NOTHING, to='CompShop.customer'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('quantity', models.IntegerField()),
                ('orderid', models.ForeignKey(db_column='orderid', on_delete=django.db.models.deletion.DO_NOTHING, to='CompShop.orders')),
                ('productid', models.ForeignKey(db_column='productid', on_delete=django.db.models.deletion.DO_NOTHING, to='CompShop.product')),
            ],
            options={
